...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.tileClean[(int(pos.x), int(pos.y))] = True
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return pos.x >= 0 and pos.y >= 0 and self.width > pos.x and self.height > pos.y
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    robot_type: class of robot to be instantiated (e.g. StandardRobot or
                RandomWalkRobot)
    """
    def oneTrial(num_robots, speed, width, height, min_coverage, robot_type):
    ...
    for j in range(num_trials):
        times.append(oneTrial(num_robots, speed, width, height, min_coverage, robot_type))
